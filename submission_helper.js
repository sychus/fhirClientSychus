...
async function AddTests_L01_2() {
    ...
    var TestParam = [];
    TestParam.push({
        Test_Key: 'L01_2_T01', PatientIdentifierValue: 'L01_2_T01',
        Family: '', Given: '', Gender: '', Birth: ''
    });
    TestParam.push({
        Test_Key: 'L01_2_T02', PatientIdentifierValue: 'L01_2_T02',
        Family: "Dougras", Given: "Jamieson Harris", Gender: "male", Birth: "1968-07-23"
    });
    TestParam.push({
        Test_Key: 'L01_2_T03', PatientIdentifierValue: 'L01_2_T02',
        Family: "Douglas", Given: "Jamieson", Gender: "male", Birth: "1968-07-23"
    });
    TestParam.push({
        Test_Key: 'L01_2_T04', PatientIdentifierValue: 'L01_2_T02',
        Family: "Douglas", Given: "Jamieson Harris", Gender: "male", Birth: "1968-07-24"
    });
    TestParam.push({
        Test_Key: 'L01_2_T05', PatientIdentifierValue: 'L01_2_T02',
        Family: "Douglas", Given: "Jamieson Harris", Gender: "female", Birth: "1968-07-23"
    });
    TestParam.push({
        Test_Key: 'L01_2_T06', PatientIdentifierValue: 'L01_2_T02',
...
async function AddTests_L04_1() {
    ...
    TestParam.push({
        Test_Key: 'L04_1_T01', PatientIdentifierValue: 'L04_1_T01',
    ...
    TestParam.push({
        Test_Key: 'L04_1_T02', PatientIdentifierValue: 'L04_1_T02',
        ObservationStatusCode: "final", ObservationDateTime: "2020-10-11T20:30:00Z",
        ObservationLOINCCode: "1975-2", ObservationLOINCDisplay: "Bilirubin, serum",
        ResultType: "numeric", NumericResultValue: "8.6", NumericResultUCUMUnit: "mg/dl",
        CodedResultSNOMEDCode: "", CodedResultSNOMEDDisplay: ""
    ...
    TestParam.push({
        Test_Key: 'L04_1_T03', PatientIdentifierValue: 'L04_1_T02',
        ObservationStatusCode: "final", ObservationDateTime: "2020-10-11T20:30:00Z",
...
async function AddTests_L04_2() {
    ...
    TestParam.push({
        Test_Key: 'L04_2_T01', PatientIdentifierValue: 'L04_2_T01',
    ...
    TestParam.push({
        Test_Key: 'L04_2_T02', PatientIdentifierValue: 'L04_2_T02',
        ImmunizationStatusCode: "completed", ImmunizationDateTime: "2021-10-25",
        ProductCVXCode: "173", ProductCVXDisplay: "cholera, BivWC", ReasonCode: ""
    });
    TestParam.push({
        Test_Key: 'L04_2_T03', PatientIdentifierValue: 'L04_2_T02',
